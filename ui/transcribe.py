...
def main():
    api_key = '14ffdad52bea4d0fb9e615a5732553bf'
    parser = argparse.ArgumentParser()
    parser.add_argument('audio_file', help='C:\\Users\\hp\\assemblyai-and-python-in-5-minutes\\audio.mp3')
    parser.add_argument('--local', action='store_true', help='must be set if audio_file is a local filename')
    parser.add_argument('--api_key', action='store', help='14ffdad52bea4d0fb9e615a5732553bf')
    ...
    if args.api_key is None:
        ...
        count=1
        if args.api_key and count is None:
